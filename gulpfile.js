...
gulp.task("watchall",async()=>{
    ...
    gulp.watch("*.html",async()=>{
        gulp.src("*.html")
        .pipe(gulp.dest("D:\\phpStudy2016\\phpStudy\\WWW\\test\\jinli"))
    });
    // 监听sass文件
    gulp.watch("sass/**/*",async()=>{
        ...
        .pipe(sass())
        .pipe(minfyCSS())
        .pipe(gulp.dest("D:\\phpStudy2016\\phpStudy\\WWW\\test\\jinli\\css"))
    })
    //监听js
     gulp.watch("js/**/*",async()=>{
        gulp.src("js/**/*")
//      .pipe(concat("js/**/*"))
//      .pipe(uglify())
        .pipe(gulp.dest("D:\\phpStudy2016\\phpStudy\\WWW\\test\\jinli\\js"))
    })
    //监听img
